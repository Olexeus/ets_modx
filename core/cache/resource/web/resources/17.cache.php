...
<div class="col-md-9 offset-md-3 col-sm-12">
    ...
    'context_key' => 'web',
    'content_type' => 1,
    'uri' => 'duplicate-of-solution-sub-item-2/',
    'uri_override' => 1,
			...
			<div class="col-md-12">
				<div class="read-more-btn-cont">
				    <div class="read-more-btn-wrap read-more-btn-prev">
			                <a href="/duplicate-of-solution-sub-item-1/" class="read-more-btn"><span>prev: </span>Duplicate of Solution sub item 1</a>
			            </div><div class="read-more-btn-wrap read-more-btn-next">
			                <a href="/duplicate-of-solution-sub-item-3/" class="read-more-btn"><span>next: </span>Duplicate of Solution sub item 3</a>
			            </div>
				</div>
			</div>
		</div>
