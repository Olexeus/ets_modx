...
gulp.task('styles', function() {
	return gulp.src('assets/app/'+syntax+'/**/*.'+syntax+'')
...
gulp.task('js', function() {
	return gulp.src([
		...
		'assets/app/libs/animate/animate.js',
...
gulp.task('watch', ['styles', 'js', 'browser-sync'], function() {
	gulp.watch('assets/app/'+syntax+'/**/*.'+syntax+'', ['styles']);
	gulp.watch(['assets/app/libs/**/*.js', 'assets/app/libs/animate/animate.js', 'assets/app/js/common.js'], ['js']);
