...
<html lang="en">
<head>
    <title>Home - ETS International</title>
    <base href="[[!++site_url]]" />
    <meta charset="UTF-8" />
    ...
    <style type="text/css">
        ...
        .logo {
            background: url(\'/ets_changer/templates/default/images/modx-logo-color.svg\') no-repeat center transparent;
            width: 220px;
            height: 85px;
...
<p>To learn more about MODX, be sure to check out the <a href="https://rtfm.modx.com/revolution/2.x/getting-started">Getting Started</a> section in the official&nbsp;documentation.</p>
    ...
    <aside>
        <a href="/ets_changer/" title="Your MODX manager" class="cta-button">Go to the&nbsp;manager</a>
