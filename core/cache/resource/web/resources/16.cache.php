<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Duplicate of Solution sub item 1',
    ...
    'description' => '',
    'alias' => 'duplicate-of-solution-sub-item-1',
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    'unpub_date' => 0,
...
<div class="col-md-9 offset-md-3 col-sm-12">
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1532368538,
    'editedby' => 1,
    'editedon' => 1532372432,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1532368500,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
    ...
    'context_key' => 'web',
    'content_type' => 1,
    'uri' => 'duplicate-of-solution-sub-item-1/',
    'uri_override' => 1,
...
<head>
	...
	<title>Duplicate of Solution sub item 1 - ETS International</title>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="product-head-bc">
					...
					&nbsp;&gt;&nbsp;
					<a><!-- I think without href -->Duplicate of Solution sub item 1</a>
				</div>
				<h4 class="product-head-title title">Duplicate of Solution sub item 1</h4>
			</div>
		</div>
	</div>
</section>
			...
			<div class="col-md-12">
				<div class="read-more-btn-cont">
				    <div class="read-more-btn-wrap read-more-btn-prev">
			                <a href="/duplicate-of-solution-sub-item-3/" class="read-more-btn"><span>prev: </span>Duplicate of Solution sub item 3</a>
			            </div><div class="read-more-btn-wrap read-more-btn-next">
			                <a href="/duplicate-of-solution-sub-item-2/" class="read-more-btn"><span>next: </span>Duplicate of Solution sub item 2</a>
			            </div>
				</div>
			</div>
		</div>
...
<!-- Footer section -->
  ...
  array (
    ...
    '[[$head? &pageTitle=`Duplicate of Solution sub item 1 - ETS International`]]' => '<!DOCTYPE html>
<html lang="ru">
